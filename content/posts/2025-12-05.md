...
例えば材料分野では、ロボットと ML とアクティブラーニングを組み合わせて新しい無機材料を自律合成する [A-Lab](https://www.nature.com/articles/s41586-023-06734-w) が Nature に載っていて、Google DeepMind の [GNoME](https://www.nature.com/articles/s41586-023-06735-9) で理論的に予測された物質から多数の新物質を実際に合成したと報告されています。
...
重要なのは、AI が仮説を出す → 人間が wet 実験で検証する → その結果を踏まえて AI が次の仮説を出す、というループが回っている点です。「AI がちゃんと新しい仮説を作って、wet 実験でもそれなりに有望だった」という事実は、AI for Science の象徴的な例だと思います。
