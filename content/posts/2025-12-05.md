...
Google が 2025 年 2 月に出した [AI Co-scientist](https://arxiv.org/abs/2502.18864) は、Gemini 2.0 をベースにした multi-agent システムで、「バーチャル共同研究者」という位置づけです。

論文と公式ブログをざっくり読むと、やっていることはだいたいこんな感じです。

- 研究者が自然言語でゴールや制約を書く
- 複数の Agent が文献を読み、関連するアイデアを大量に出す
- 別の Agent が、新規性や一貫性をチェックしながら仮説を絞り込む
...
FutureHouse の [Robin](https://www.futurehouse.org/research-announcements/demonstrating-end-to-end-scientific-discovery-with-robin-a-multi-agent-system) は、創薬寄りの領域で話題になった multi-agent システムです。
...
ここまで、実験環境と評価軸という 2 つのギャップについて書いてきました。1 チームで A-Lab や Robin のような full-stack の self-driving lab を再現するのは、正直かなり厳しいと思います。
