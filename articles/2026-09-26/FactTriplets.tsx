...
/** A triplet as read from articles/2026-09-26/data/card.json (built by
 * articles/2026-09-26/scripts/build_card_data.py from the frozen v6 counterfactual set). */
