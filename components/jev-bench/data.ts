import raw from '@/content/data/jev-bench.json';
...
/** Placeholder ids the article may embed as `<div data-jev-figure="…">`. */
export const jevFigureIds = ['accuracy', 'probability', 'seqqa', 'clintox'] as const;

export type JevFigureId = (typeof jevFigureIds)[number];

export function isJevFigureId(id: string): id is JevFigureId {
  return (jevFigureIds as readonly string[]).includes(id);
}
